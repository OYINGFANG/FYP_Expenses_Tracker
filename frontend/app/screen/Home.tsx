...
const styles = StyleSheet.create({
  ...
  balanceContainer: { alignItems: "center", paddingVertical: 13, paddingHorizontal: 15, borderRadius: 15, backgroundColor: "#1E3932", width: "100%" },
  ...
  incomeExpenseRow: { flexDirection: "row", gap: 15, width: "100%" },
  incomeBox: { flex: 1, backgroundColor: "rgba(255, 255, 255, 0.1)", borderRadius: 10, padding: 5 },
  expenseBox: { flex: 1, backgroundColor: "rgba(255, 255, 255, 0.1)", borderRadius: 10, padding: 5 },
  incomeHeader: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 6 },
  incomeLabel: { color: "#C9EAD6", fontSize: 15, marginLeft: 10 },
  incomeValue: { color: "#fff", fontSize: 16, fontWeight: "700", marginLeft: 25 },
  actionRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 15, width: "100%", gap: 8 },
  actionBox: { flex: 1, height: 78, alignItems: "center", justifyContent: "center", borderRadius: 12 },
