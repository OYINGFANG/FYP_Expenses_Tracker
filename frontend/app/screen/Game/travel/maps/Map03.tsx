// app/screen/Game/components/maps/Map03.tsx (React Native)
...
const Map03: React.FC<Props> = ({ location, availableLocations, handleLocationSelect }) => {
  ...
  const getDotFill = (dotLocation: string): string => {
  ...
  // helper to render a dot without duplicate `fill`
  const renderDot = (
    cx: number,
    cy: number,
    testID: string,
    name: string,
    defaultFill: string = '#08a200'
  ) => {
    const fill = getDotFill(name) || defaultFill;
    return (
      <G>
        <Circle
          cx={cx}
  ...
  return (
    <View style={styles.container}>
      <Svg viewBox="0 0 100 100" width="100%" height="100%" testID="map-03">
        <Defs>
          {/* Gradients (no xlinkHref; we inline stops for RN-SVG) */}
          ...
          <SvgLinearGradient id="linearGradient6776" x1="75.556" x2="74.013" y1="77.781" y2="120.389">
            <Stop offset="0" stopColor="#4ac9fd" stopOpacity={1} />
            <Stop offset="1" stopColor="#4a90fd" stopOpacity={1} />
          </SvgLinearGradient>
          ...
          <SvgLinearGradient id="linearGradient10201" x1="31.069" x2="-9.412" y1="86.018" y2="105.473">
            <Stop offset="0" stopColor="#008d00" stopOpacity={1} />
            <Stop offset="1" stopColor="#007600" stopOpacity={1} />
          </SvgLinearGradient>

          <SvgLinearGradient id="linearGradient10427" x1="-14.302" x2="31.287" y1="21.741" y2="5.751">
            <Stop offset="0" stopColor="#007400" stopOpacity={1} />
            <Stop offset="1" stopColor="#009100" stopOpacity={1} />
          </SvgLinearGradient>

          <SvgLinearGradient id="linearGradient15741" x1="75.515" x2="92.363" y1="-23.487" y2="-50.41">
            <Stop offset="0" stopColor="#008d00" stopOpacity={1} />
            <Stop offset="1" stopColor="#007600" stopOpacity={1} />
          </SvgLinearGradient>
        </Defs>
        ...
        <G strokeWidth={1.96} transform="matrix(.5102 0 0 .5102 24.137 24.247)">
          <G clipPath="url(#clipPath4967)" transform="translate(.692 .476)" strokeWidth={1.96}>
            {/* background */}
            <Path fill="url(#radialGradient4244)" d="M-48 -48H148V148H-48z" />

            {/* terrain shapes */}
            <G strokeLinejoin="round" strokeWidth={1.96}>
              <Path
                fill="#0d630d"
            ...
            <G>
              ...
              <Path
                ...
                transform="translate(-.692 -.476)"
              />
              <Path fill="#999" d="M55.907 50.56l-.726-5.443L57.6 41.61l6.289.847-5.805.483 2.54 5.2-3.266-3.023z" />
              <Path fill="#999" d="M45.99 57.453L44.9 52.01l-5.08 5.2 5.201-7.377 6.652-3.507-4.233 3.628 6.41.483-7.136.726z" />
              <Path fill="#999" d="M48.65 43.061l1.452-4.958 4.716.12 4.475.243-5.684 1.209-.847 4.958-1.21-3.507-1.45 4.233v-2.902z" />
            </G>
          ...
          >
            ...
            <Path d="M-27.61 38.526c2.438 8.036-.21 15.73 14.09 17.005" />
            <Path d="M-23.876 13.568c-11.563 2.903-7.1 11.151-4.233 21.76" />
            <Path d="M-30.41-12.1c4.771 1.27 14.257 15.253 9.89 22.362" />
            <Path d="M-22.01-27.267c-5.79-6.542-23.397 7.925-12.39 13.112" />
            ...
            <Path d="M131.747 91.462c1.136-13.282-7.16-18.833-18.216-17.119" />
            <Path d="M139.635 110.458c1.136-13.283-9.293-8.58-7.975-15.792" />
          ...
          <G strokeWidth={1.96} transform="translate(.816 1.218)">
            {renderDot(23.925, 35.07, 'btn-oskah', 'oskah', '#08a200')}
            {location === 'oskah' && (
              <Path
                fill="#e92828"
                stroke="#520"
          ...
          <G strokeWidth={1.96} transform="translate(-31.115 20.743)">
            {renderDot(23.925, 35.07, 'btn-luci', 'luci', '#08a200')}
            {location === 'luci' && (
              <Path
                fill="#e92828"
                stroke="#520"
          ...
          <G strokeWidth={1.96} transform="translate(82.13 36.105)">
            {renderDot(23.925, 35.07, 'btn-clionne', 'clionne', '#08a200')}
            {location === 'clionne' && (
              <Path
                fill="#e92828"
                stroke="#520"
          ...
          <G strokeWidth={1.96} transform="translate(-39.412 -61.193)">
            {renderDot(23.925, 35.07, 'btn-winnie', 'winnie', '#08a200')}
            {location === 'winnie' && (
              <Path
                fill="#e92828"
                stroke="#520"
          ...
          <G strokeWidth={1.96} transform="translate(97.89 88.046)">
            {renderDot(23.925, 35.07, 'btn-tigi', 'tigi', '#08a200')}
            {location === 'tigi' && (
              <Path
                fill="#e92828"
                stroke="#520"
      ...
      {availableLocations.map((loc) => {
        ...
        const basePositions: { [key: string]: { x: number; y: number; transform?: { x: number; y: number } } } = {
          ...
          winnie: { x: 23.925, y: 35.07, transform: { x: -39.412, y: -61.193 } },
          tigi: { x: 23.925, y: 35.07, transform: { x: 97.89, y: 88.046 } },
        };
        const pos = basePositions[loc];
        if (!pos) return null;
        
        // Calculate final position accounting for transforms
        const finalX = pos.x + (pos.transform?.x || 0);
        const finalY = pos.y + (pos.transform?.y || 0);
